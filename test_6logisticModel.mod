...
set bmltsIndex_PTVHD_215 ;
set voxelbmlt_PTVHD_215 within {voxelIndex_PTVHD,bmltsIndex_PTVHD_215};
param intensities_PTVHD_215 {voxelbmlt_PTVHD_215} >=0;
...
set bmltsIndex_RECTUM_215 ;
set voxelbmlt_RECTUM_215 within {voxelIndex_RECTUM,bmltsIndex_RECTUM_215};
param intensities_RECTUM_215 {voxelbmlt_RECTUM_215} >=0;
...
set bmltsIndex_BLADDER_215 ;
set voxelbmlt_BLADDER_215 within {voxelIndex_BLADDER,bmltsIndex_BLADDER_215};
param intensities_BLADDER_215 {voxelbmlt_BLADDER_215} >=0;
...
var x215 {1 .. 70} >= 0, <=30.0, default 1; 
...
+(sum{j in bmltsIndex_RECTUM_215: (i,j) in voxelbmlt_RECTUM_215} x215[j]*intensities_RECTUM_215[i,j]) 
...
+(sum{j in bmltsIndex_BLADDER_215: (i,j) in voxelbmlt_BLADDER_215} x215[j]*intensities_BLADDER_215[i,j]) 
...
+(sum {j in bmltsIndex_PTVHD_215: (i,j) in voxelbmlt_PTVHD_215} x215[j]*intensities_PTVHD_215[i,j]) 
