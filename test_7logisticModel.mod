...
set bmltsIndex_PTVHD_290 ;
set voxelbmlt_PTVHD_290 within {voxelIndex_PTVHD,bmltsIndex_PTVHD_290};
param intensities_PTVHD_290 {voxelbmlt_PTVHD_290} >=0;
param R_RECTUM;
...
set bmltsIndex_RECTUM_290 ;
set voxelbmlt_RECTUM_290 within {voxelIndex_RECTUM,bmltsIndex_RECTUM_290};
param intensities_RECTUM_290 {voxelbmlt_RECTUM_290} >=0;
param R_BLADDER;
...
set bmltsIndex_BLADDER_290 ;
set voxelbmlt_BLADDER_290 within {voxelIndex_BLADDER,bmltsIndex_BLADDER_290};
param intensities_BLADDER_290 {voxelbmlt_BLADDER_290} >=0;
param bmlt150;
param bmlt220;
param bmlt255;
param bmlt275;
...
var x290 {1 .. 64} >= 0, <=30.0, default 1; 
param a{1 .. 4}; 
param v{1 .. 4}; 
param EUD0{1 .. 4}; 
...
+(sum{j in bmltsIndex_RECTUM_290: (i,j) in voxelbmlt_RECTUM_290} x290[j]*intensities_RECTUM_290[i,j]) 
...
+(sum{j in bmltsIndex_BLADDER_290: (i,j) in voxelbmlt_BLADDER_290} x290[j]*intensities_BLADDER_290[i,j]) 
...
+(sum {j in bmltsIndex_PTVHD_290: (i,j) in voxelbmlt_PTVHD_290} x290[j]*intensities_PTVHD_290[i,j]) 
)^a[1])))^(1/a[1]) >= t; 
